...
#define XROW_PRODUCT_CONTROL_ADDR_AP_CTRL       0x00
#define XROW_PRODUCT_CONTROL_ADDR_GIE           0x04
#define XROW_PRODUCT_CONTROL_ADDR_IER           0x08
#define XROW_PRODUCT_CONTROL_ADDR_ISR           0x0c

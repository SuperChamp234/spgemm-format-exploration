...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.row_product.autotvin_x_rowptr.dat"
         "c.row_product.autotvin_x_colind.dat"
         "c.row_product.autotvin_x_data.dat"
         "c.row_product.autotvin_y_rowptr.dat"
         "c.row_product.autotvin_y_colind.dat"
         "c.row_product.autotvin_y_data.dat"
         "c.row_product.autotvin_z_rowptr.dat"
         "c.row_product.autotvout_z_rowptr.dat"
         "c.row_product.autotvout_z_colind.dat"
         "c.row_product.autotvout_z_data.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.row_product.autotvout_z_rowptr.dat"
         "rtl.row_product.autotvout_z_colind.dat"
         "rtl.row_product.autotvout_z_data.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

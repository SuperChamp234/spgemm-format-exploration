...
if {[file isfile row_product.autotvin.dat]} {
	file delete -force row_product.autotvin.dat
}

if {[file isfile row_product.autotvout.dat]} {
	file delete -force row_product.autotvout.dat
}

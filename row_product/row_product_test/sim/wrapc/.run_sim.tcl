...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "row_product.autotvin.dat"
	set constFileTvOut       "row_product.autotvout.dat"
	set constFileHdlTvIn     "row_product.autohdltvin.dat"
	set constFileHdlTvOut    "row_product.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

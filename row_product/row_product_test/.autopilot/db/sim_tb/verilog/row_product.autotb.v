...
`define AUTOTB_DUT      row_product
`define AUTOTB_DUT_INST AESL_inst_row_product
`define AUTOTB_TOP      apatb_row_product_top
`define AUTOTB_LAT_RESULT_FILE "row_product.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "row_product.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_row_product_top
...
`define AESL_DEPTH_y_rowptr 1
`define AESL_DEPTH_y_colind 1
`define AESL_DEPTH_y_data 1
`define AESL_DEPTH_z_rowptr 1
`define AESL_DEPTH_z_colind 1
`define AESL_DEPTH_z_data 1
`define AUTOTB_TVIN_x_rowptr  "./c.row_product.autotvin_x_rowptr.dat"
`define AUTOTB_TVIN_x_colind  "./c.row_product.autotvin_x_colind.dat"
`define AUTOTB_TVIN_x_data  "./c.row_product.autotvin_x_data.dat"
`define AUTOTB_TVIN_y_rowptr  "./c.row_product.autotvin_y_rowptr.dat"
`define AUTOTB_TVIN_y_colind  "./c.row_product.autotvin_y_colind.dat"
`define AUTOTB_TVIN_y_data  "./c.row_product.autotvin_y_data.dat"
`define AUTOTB_TVIN_z_rowptr  "./c.row_product.autotvin_z_rowptr.dat"
`define AUTOTB_TVIN_x_rowptr_out_wrapc  "./rtl.row_product.autotvin_x_rowptr.dat"
`define AUTOTB_TVIN_x_colind_out_wrapc  "./rtl.row_product.autotvin_x_colind.dat"
`define AUTOTB_TVIN_x_data_out_wrapc  "./rtl.row_product.autotvin_x_data.dat"
`define AUTOTB_TVIN_y_rowptr_out_wrapc  "./rtl.row_product.autotvin_y_rowptr.dat"
`define AUTOTB_TVIN_y_colind_out_wrapc  "./rtl.row_product.autotvin_y_colind.dat"
`define AUTOTB_TVIN_y_data_out_wrapc  "./rtl.row_product.autotvin_y_data.dat"
`define AUTOTB_TVIN_z_rowptr_out_wrapc  "./rtl.row_product.autotvin_z_rowptr.dat"
`define AUTOTB_TVOUT_z_rowptr  "./c.row_product.autotvout_z_rowptr.dat"
`define AUTOTB_TVOUT_z_colind  "./c.row_product.autotvout_z_colind.dat"
`define AUTOTB_TVOUT_z_data  "./c.row_product.autotvout_z_data.dat"
`define AUTOTB_TVOUT_z_rowptr_out_wrapc  "./impl_rtl.row_product.autotvout_z_rowptr.dat"
`define AUTOTB_TVOUT_z_colind_out_wrapc  "./impl_rtl.row_product.autotvout_z_colind.dat"
`define AUTOTB_TVOUT_z_data_out_wrapc  "./impl_rtl.row_product.autotvout_z_data.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_y_rowptr = 25;
parameter LENGTH_y_colind = 25;
...
wire  y_rowptr_AWVALID;
wire  y_rowptr_AWREADY;
wire [63 : 0] y_rowptr_AWADDR;
wire [0 : 0] y_rowptr_AWID;
wire [7 : 0] y_rowptr_AWLEN;
wire [2 : 0] y_rowptr_AWSIZE;
wire [1 : 0] y_rowptr_AWBURST;
wire [1 : 0] y_rowptr_AWLOCK;
wire [3 : 0] y_rowptr_AWCACHE;
wire [2 : 0] y_rowptr_AWPROT;
wire [3 : 0] y_rowptr_AWQOS;
wire [3 : 0] y_rowptr_AWREGION;
wire [0 : 0] y_rowptr_AWUSER;
wire  y_rowptr_WVALID;
wire  y_rowptr_WREADY;
wire [31 : 0] y_rowptr_WDATA;
wire [3 : 0] y_rowptr_WSTRB;
wire  y_rowptr_WLAST;
wire [0 : 0] y_rowptr_WID;
wire [0 : 0] y_rowptr_WUSER;
wire  y_rowptr_ARVALID;
wire  y_rowptr_ARREADY;
wire [63 : 0] y_rowptr_ARADDR;
wire [0 : 0] y_rowptr_ARID;
wire [7 : 0] y_rowptr_ARLEN;
wire [2 : 0] y_rowptr_ARSIZE;
wire [1 : 0] y_rowptr_ARBURST;
wire [1 : 0] y_rowptr_ARLOCK;
wire [3 : 0] y_rowptr_ARCACHE;
wire [2 : 0] y_rowptr_ARPROT;
wire [3 : 0] y_rowptr_ARQOS;
wire [3 : 0] y_rowptr_ARREGION;
wire [0 : 0] y_rowptr_ARUSER;
wire  y_rowptr_RVALID;
wire  y_rowptr_RREADY;
...
wire  y_rowptr_BREADY;
wire [1 : 0] y_rowptr_BRESP;
wire [0 : 0] y_rowptr_BID;
wire [0 : 0] y_rowptr_BUSER;
wire  y_colind_AWVALID;
wire  y_colind_AWREADY;
wire [63 : 0] y_colind_AWADDR;
wire [0 : 0] y_colind_AWID;
wire [7 : 0] y_colind_AWLEN;
wire [2 : 0] y_colind_AWSIZE;
wire [1 : 0] y_colind_AWBURST;
wire [1 : 0] y_colind_AWLOCK;
wire [3 : 0] y_colind_AWCACHE;
wire [2 : 0] y_colind_AWPROT;
wire [3 : 0] y_colind_AWQOS;
wire [3 : 0] y_colind_AWREGION;
wire [0 : 0] y_colind_AWUSER;
wire  y_colind_WVALID;
wire  y_colind_WREADY;
wire [31 : 0] y_colind_WDATA;
wire [3 : 0] y_colind_WSTRB;
wire  y_colind_WLAST;
wire [0 : 0] y_colind_WID;
wire [0 : 0] y_colind_WUSER;
wire  y_colind_ARVALID;
wire  y_colind_ARREADY;
wire [63 : 0] y_colind_ARADDR;
wire [0 : 0] y_colind_ARID;
wire [7 : 0] y_colind_ARLEN;
wire [2 : 0] y_colind_ARSIZE;
wire [1 : 0] y_colind_ARBURST;
wire [1 : 0] y_colind_ARLOCK;
wire [3 : 0] y_colind_ARCACHE;
wire [2 : 0] y_colind_ARPROT;
wire [3 : 0] y_colind_ARQOS;
wire [3 : 0] y_colind_ARREGION;
wire [0 : 0] y_colind_ARUSER;
wire  y_colind_RVALID;
wire  y_colind_RREADY;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .m_axi_y_rowptr_AWVALID(y_rowptr_AWVALID),
    .m_axi_y_rowptr_AWREADY(y_rowptr_AWREADY),
    .m_axi_y_rowptr_AWADDR(y_rowptr_AWADDR),
    .m_axi_y_rowptr_AWID(y_rowptr_AWID),
    .m_axi_y_rowptr_AWLEN(y_rowptr_AWLEN),
    .m_axi_y_rowptr_AWSIZE(y_rowptr_AWSIZE),
    .m_axi_y_rowptr_AWBURST(y_rowptr_AWBURST),
    .m_axi_y_rowptr_AWLOCK(y_rowptr_AWLOCK),
    .m_axi_y_rowptr_AWCACHE(y_rowptr_AWCACHE),
    .m_axi_y_rowptr_AWPROT(y_rowptr_AWPROT),
    .m_axi_y_rowptr_AWQOS(y_rowptr_AWQOS),
    .m_axi_y_rowptr_AWREGION(y_rowptr_AWREGION),
    .m_axi_y_rowptr_AWUSER(y_rowptr_AWUSER),
    .m_axi_y_rowptr_WVALID(y_rowptr_WVALID),
    .m_axi_y_rowptr_WREADY(y_rowptr_WREADY),
    .m_axi_y_rowptr_WDATA(y_rowptr_WDATA),
    .m_axi_y_rowptr_WSTRB(y_rowptr_WSTRB),
    .m_axi_y_rowptr_WLAST(y_rowptr_WLAST),
    .m_axi_y_rowptr_WID(y_rowptr_WID),
    .m_axi_y_rowptr_WUSER(y_rowptr_WUSER),
    .m_axi_y_rowptr_ARVALID(y_rowptr_ARVALID),
    .m_axi_y_rowptr_ARREADY(y_rowptr_ARREADY),
    .m_axi_y_rowptr_ARADDR(y_rowptr_ARADDR),
    .m_axi_y_rowptr_ARID(y_rowptr_ARID),
    .m_axi_y_rowptr_ARLEN(y_rowptr_ARLEN),
    .m_axi_y_rowptr_ARSIZE(y_rowptr_ARSIZE),
    .m_axi_y_rowptr_ARBURST(y_rowptr_ARBURST),
    .m_axi_y_rowptr_ARLOCK(y_rowptr_ARLOCK),
    .m_axi_y_rowptr_ARCACHE(y_rowptr_ARCACHE),
    .m_axi_y_rowptr_ARPROT(y_rowptr_ARPROT),
    .m_axi_y_rowptr_ARQOS(y_rowptr_ARQOS),
    .m_axi_y_rowptr_ARREGION(y_rowptr_ARREGION),
    .m_axi_y_rowptr_ARUSER(y_rowptr_ARUSER),
    .m_axi_y_rowptr_RVALID(y_rowptr_RVALID),
    .m_axi_y_rowptr_RREADY(y_rowptr_RREADY),
    ...
    .m_axi_y_rowptr_BVALID(y_rowptr_BVALID),
    .m_axi_y_rowptr_BREADY(y_rowptr_BREADY),
    .m_axi_y_rowptr_BRESP(y_rowptr_BRESP),
    .m_axi_y_rowptr_BID(y_rowptr_BID),
    .m_axi_y_rowptr_BUSER(y_rowptr_BUSER),
    .m_axi_y_colind_AWVALID(y_colind_AWVALID),
    .m_axi_y_colind_AWREADY(y_colind_AWREADY),
    .m_axi_y_colind_AWADDR(y_colind_AWADDR),
    .m_axi_y_colind_AWID(y_colind_AWID),
    .m_axi_y_colind_AWLEN(y_colind_AWLEN),
    .m_axi_y_colind_AWSIZE(y_colind_AWSIZE),
    .m_axi_y_colind_AWBURST(y_colind_AWBURST),
    .m_axi_y_colind_AWLOCK(y_colind_AWLOCK),
    .m_axi_y_colind_AWCACHE(y_colind_AWCACHE),
    .m_axi_y_colind_AWPROT(y_colind_AWPROT),
    .m_axi_y_colind_AWQOS(y_colind_AWQOS),
    .m_axi_y_colind_AWREGION(y_colind_AWREGION),
    .m_axi_y_colind_AWUSER(y_colind_AWUSER),
    .m_axi_y_colind_WVALID(y_colind_WVALID),
    .m_axi_y_colind_WREADY(y_colind_WREADY),
    .m_axi_y_colind_WDATA(y_colind_WDATA),
    .m_axi_y_colind_WSTRB(y_colind_WSTRB),
    .m_axi_y_colind_WLAST(y_colind_WLAST),
    .m_axi_y_colind_WID(y_colind_WID),
    .m_axi_y_colind_WUSER(y_colind_WUSER),
    .m_axi_y_colind_ARVALID(y_colind_ARVALID),
    .m_axi_y_colind_ARREADY(y_colind_ARREADY),
    .m_axi_y_colind_ARADDR(y_colind_ARADDR),
    .m_axi_y_colind_ARID(y_colind_ARID),
    .m_axi_y_colind_ARLEN(y_colind_ARLEN),
    .m_axi_y_colind_ARSIZE(y_colind_ARSIZE),
    .m_axi_y_colind_ARBURST(y_colind_ARBURST),
    .m_axi_y_colind_ARLOCK(y_colind_ARLOCK),
    .m_axi_y_colind_ARCACHE(y_colind_ARCACHE),
    .m_axi_y_colind_ARPROT(y_colind_ARPROT),
    .m_axi_y_colind_ARQOS(y_colind_ARQOS),
    .m_axi_y_colind_ARREGION(y_colind_ARREGION),
    .m_axi_y_colind_ARUSER(y_colind_ARUSER),
    .m_axi_y_colind_RVALID(y_colind_RVALID),
    .m_axi_y_colind_RREADY(y_colind_RREADY),
    ...
    .m_axi_y_colind_BVALID(y_colind_BVALID),
    .m_axi_y_colind_BREADY(y_colind_BREADY),
    .m_axi_y_colind_BRESP(y_colind_BRESP),
    .m_axi_y_colind_BID(y_colind_BID),
    .m_axi_y_colind_BUSER(y_colind_BUSER),
...
wire    AESL_axi_master_y_rowptr_ready;
wire    AESL_axi_master_y_rowptr_done;
AESL_axi_master_y_rowptr AESL_AXI_MASTER_y_rowptr(
    .clk   (AESL_clock),
    .reset (AESL_reset),
    .TRAN_y_rowptr_AWVALID (y_rowptr_AWVALID),
    .TRAN_y_rowptr_AWREADY (y_rowptr_AWREADY),
    .TRAN_y_rowptr_AWADDR (y_rowptr_AWADDR),
    .TRAN_y_rowptr_AWID (y_rowptr_AWID),
    .TRAN_y_rowptr_AWLEN (y_rowptr_AWLEN),
    .TRAN_y_rowptr_AWSIZE (y_rowptr_AWSIZE),
    .TRAN_y_rowptr_AWBURST (y_rowptr_AWBURST),
    .TRAN_y_rowptr_AWLOCK (y_rowptr_AWLOCK),
    .TRAN_y_rowptr_AWCACHE (y_rowptr_AWCACHE),
    .TRAN_y_rowptr_AWPROT (y_rowptr_AWPROT),
    .TRAN_y_rowptr_AWQOS (y_rowptr_AWQOS),
    .TRAN_y_rowptr_AWREGION (y_rowptr_AWREGION),
    .TRAN_y_rowptr_AWUSER (y_rowptr_AWUSER),
    .TRAN_y_rowptr_WVALID (y_rowptr_WVALID),
    .TRAN_y_rowptr_WREADY (y_rowptr_WREADY),
    .TRAN_y_rowptr_WDATA (y_rowptr_WDATA),
    .TRAN_y_rowptr_WSTRB (y_rowptr_WSTRB),
    .TRAN_y_rowptr_WLAST (y_rowptr_WLAST),
    .TRAN_y_rowptr_WID (y_rowptr_WID),
    .TRAN_y_rowptr_WUSER (y_rowptr_WUSER),
    .TRAN_y_rowptr_ARVALID (y_rowptr_ARVALID),
    .TRAN_y_rowptr_ARREADY (y_rowptr_ARREADY),
    .TRAN_y_rowptr_ARADDR (y_rowptr_ARADDR),
    .TRAN_y_rowptr_ARID (y_rowptr_ARID),
    .TRAN_y_rowptr_ARLEN (y_rowptr_ARLEN),
    .TRAN_y_rowptr_ARSIZE (y_rowptr_ARSIZE),
    .TRAN_y_rowptr_ARBURST (y_rowptr_ARBURST),
    .TRAN_y_rowptr_ARLOCK (y_rowptr_ARLOCK),
    .TRAN_y_rowptr_ARCACHE (y_rowptr_ARCACHE),
    .TRAN_y_rowptr_ARPROT (y_rowptr_ARPROT),
    .TRAN_y_rowptr_ARQOS (y_rowptr_ARQOS),
    .TRAN_y_rowptr_ARREGION (y_rowptr_ARREGION),
    .TRAN_y_rowptr_ARUSER (y_rowptr_ARUSER),
    .TRAN_y_rowptr_RVALID (y_rowptr_RVALID),
    .TRAN_y_rowptr_RREADY (y_rowptr_RREADY),
    .TRAN_y_rowptr_RDATA (y_rowptr_RDATA),
    .TRAN_y_rowptr_RLAST (y_rowptr_RLAST),
    .TRAN_y_rowptr_RID (y_rowptr_RID),
    .TRAN_y_rowptr_RUSER (y_rowptr_RUSER),
    .TRAN_y_rowptr_RRESP (y_rowptr_RRESP),
    .TRAN_y_rowptr_BVALID (y_rowptr_BVALID),
    .TRAN_y_rowptr_BREADY (y_rowptr_BREADY),
    .TRAN_y_rowptr_BRESP (y_rowptr_BRESP),
    .TRAN_y_rowptr_BID (y_rowptr_BID),
    .TRAN_y_rowptr_BUSER (y_rowptr_BUSER),
    .ready (AESL_axi_master_y_rowptr_ready),
    .done  (AESL_axi_master_y_rowptr_done)
);
assign    AESL_axi_master_y_rowptr_ready    =   ready;
assign    AESL_axi_master_y_rowptr_done    =   AESL_done_delay;
wire    AESL_axi_master_y_colind_ready;
wire    AESL_axi_master_y_colind_done;
AESL_axi_master_y_colind AESL_AXI_MASTER_y_colind(
    .clk   (AESL_clock),
    .reset (AESL_reset),
    .TRAN_y_colind_AWVALID (y_colind_AWVALID),
    .TRAN_y_colind_AWREADY (y_colind_AWREADY),
    .TRAN_y_colind_AWADDR (y_colind_AWADDR),
    .TRAN_y_colind_AWID (y_colind_AWID),
    .TRAN_y_colind_AWLEN (y_colind_AWLEN),
    .TRAN_y_colind_AWSIZE (y_colind_AWSIZE),
    .TRAN_y_colind_AWBURST (y_colind_AWBURST),
    .TRAN_y_colind_AWLOCK (y_colind_AWLOCK),
    .TRAN_y_colind_AWCACHE (y_colind_AWCACHE),
    .TRAN_y_colind_AWPROT (y_colind_AWPROT),
    .TRAN_y_colind_AWQOS (y_colind_AWQOS),
    .TRAN_y_colind_AWREGION (y_colind_AWREGION),
    .TRAN_y_colind_AWUSER (y_colind_AWUSER),
    .TRAN_y_colind_WVALID (y_colind_WVALID),
    .TRAN_y_colind_WREADY (y_colind_WREADY),
    .TRAN_y_colind_WDATA (y_colind_WDATA),
    .TRAN_y_colind_WSTRB (y_colind_WSTRB),
    .TRAN_y_colind_WLAST (y_colind_WLAST),
    .TRAN_y_colind_WID (y_colind_WID),
    .TRAN_y_colind_WUSER (y_colind_WUSER),
    .TRAN_y_colind_ARVALID (y_colind_ARVALID),
    .TRAN_y_colind_ARREADY (y_colind_ARREADY),
    .TRAN_y_colind_ARADDR (y_colind_ARADDR),
    .TRAN_y_colind_ARID (y_colind_ARID),
    .TRAN_y_colind_ARLEN (y_colind_ARLEN),
    .TRAN_y_colind_ARSIZE (y_colind_ARSIZE),
    .TRAN_y_colind_ARBURST (y_colind_ARBURST),
    .TRAN_y_colind_ARLOCK (y_colind_ARLOCK),
    .TRAN_y_colind_ARCACHE (y_colind_ARCACHE),
    .TRAN_y_colind_ARPROT (y_colind_ARPROT),
    .TRAN_y_colind_ARQOS (y_colind_ARQOS),
    .TRAN_y_colind_ARREGION (y_colind_ARREGION),
    .TRAN_y_colind_ARUSER (y_colind_ARUSER),
    .TRAN_y_colind_RVALID (y_colind_RVALID),
    .TRAN_y_colind_RREADY (y_colind_RREADY),
    .TRAN_y_colind_RDATA (y_colind_RDATA),
    .TRAN_y_colind_RLAST (y_colind_RLAST),
    .TRAN_y_colind_RID (y_colind_RID),
    .TRAN_y_colind_RUSER (y_colind_RUSER),
    .TRAN_y_colind_RRESP (y_colind_RRESP),
    .TRAN_y_colind_BVALID (y_colind_BVALID),
    .TRAN_y_colind_BREADY (y_colind_BREADY),
    .TRAN_y_colind_BRESP (y_colind_BRESP),
    .TRAN_y_colind_BID (y_colind_BID),
    .TRAN_y_colind_BUSER (y_colind_BUSER),
    .ready (AESL_axi_master_y_colind_ready),
    .done  (AESL_axi_master_y_colind_done)
);
assign    AESL_axi_master_y_colind_ready    =   ready;
assign    AESL_axi_master_y_colind_done    =   AESL_done_delay;
...
reg end_y_rowptr;
reg [31:0] size_y_rowptr;
reg [31:0] size_y_rowptr_backup;
reg end_y_colind;
reg [31:0] size_y_colind;
reg [31:0] size_y_colind_backup;
reg end_y_data;

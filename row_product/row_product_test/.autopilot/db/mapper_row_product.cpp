...
extern "C" void row_product(int*, int*, long long*, int*, int*, long long*, int*, int*, long long*);
extern "C" void apatb_row_product_hw(volatile void * __xlx_apatb_param_x_rowptr, volatile void * __xlx_apatb_param_x_colind, volatile void * __xlx_apatb_param_x_data, volatile void * __xlx_apatb_param_y_rowptr, volatile void * __xlx_apatb_param_y_colind, volatile void * __xlx_apatb_param_y_data, volatile void * __xlx_apatb_param_z_rowptr, volatile void * __xlx_apatb_param_z_colind, volatile void * __xlx_apatb_param_z_data) {
  ...
  vector<sc_bv<64> >__xlx_x_data__tmp_vec;
  for (int j = 0, e = 1024; j != e; ++j) {
    __xlx_x_data__tmp_vec.push_back(((long long*)__xlx_apatb_param_x_data)[j]);
  }
  int __xlx_size_param_x_data = 1024;
  int __xlx_offset_param_x_data = 0;
  int __xlx_offset_byte_param_x_data = 0*8;
  long long* __xlx_x_data__input_buffer= new long long[__xlx_x_data__tmp_vec.size()];
  for (int i = 0; i < __xlx_x_data__tmp_vec.size(); ++i) {
    __xlx_x_data__input_buffer[i] = __xlx_x_data__tmp_vec[i].range(63, 0).to_uint64();
  }
  ...
  vector<sc_bv<64> >__xlx_y_data__tmp_vec;
  for (int j = 0, e = 1024; j != e; ++j) {
    __xlx_y_data__tmp_vec.push_back(((long long*)__xlx_apatb_param_y_data)[j]);
  }
  int __xlx_size_param_y_data = 1024;
  int __xlx_offset_param_y_data = 0;
  int __xlx_offset_byte_param_y_data = 0*8;
  long long* __xlx_y_data__input_buffer= new long long[__xlx_y_data__tmp_vec.size()];
  for (int i = 0; i < __xlx_y_data__tmp_vec.size(); ++i) {
    __xlx_y_data__input_buffer[i] = __xlx_y_data__tmp_vec[i].range(63, 0).to_uint64();
  }
  ...
  vector<sc_bv<64> >__xlx_z_data__tmp_vec;
  for (int j = 0, e = 1024; j != e; ++j) {
    __xlx_z_data__tmp_vec.push_back(((long long*)__xlx_apatb_param_z_data)[j]);
  }
  int __xlx_size_param_z_data = 1024;
  int __xlx_offset_param_z_data = 0;
  int __xlx_offset_byte_param_z_data = 0*8;
  long long* __xlx_z_data__input_buffer= new long long[__xlx_z_data__tmp_vec.size()];
  for (int i = 0; i < __xlx_z_data__tmp_vec.size(); ++i) {
    __xlx_z_data__input_buffer[i] = __xlx_z_data__tmp_vec[i].range(63, 0).to_uint64();
  }
  // DUT call

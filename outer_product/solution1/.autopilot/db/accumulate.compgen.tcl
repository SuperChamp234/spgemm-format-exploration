...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { agg_result_colind_address0 { O 18 vector } agg_result_colind_ce0 { O 1 bit } agg_result_colind_we0 { O 1 bit } agg_result_colind_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { agg_result_data_V_address0 { O 18 vector } agg_result_data_V_ce0 { O 1 bit } agg_result_data_V_we0 { O 1 bit } agg_result_data_V_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { csr1_rowptr_address0 { O 9 vector } csr1_rowptr_ce0 { O 1 bit } csr1_rowptr_q0 { I 32 vector } csr1_rowptr_address1 { O 9 vector } csr1_rowptr_ce1 { O 1 bit } csr1_rowptr_q1 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { csr1_colind_address0 { O 18 vector } csr1_colind_ce0 { O 1 bit } csr1_colind_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { csr1_data_V_address0 { O 18 vector } csr1_data_V_ce0 { O 1 bit } csr1_data_V_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { csr2_rowptr_address0 { O 9 vector } csr2_rowptr_ce0 { O 1 bit } csr2_rowptr_q0 { I 32 vector } csr2_rowptr_address1 { O 9 vector } csr2_rowptr_ce1 { O 1 bit } csr2_rowptr_q1 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { csr2_colind_address0 { O 18 vector } csr2_colind_ce0 { O 1 bit } csr2_colind_q0 { I 9 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { csr2_data_V_address0 { O 18 vector } csr2_data_V_ce0 { O 1 bit } csr2_data_V_q0 { I 32 vector } } \
} "
} else {

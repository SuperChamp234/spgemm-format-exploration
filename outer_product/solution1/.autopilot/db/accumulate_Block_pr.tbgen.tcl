set moduleName accumulate_Block_pr
...
set C_modelName {accumulate_Block__pr}
...
set portList { 
	...
	{ csr1_rowptr_address0 sc_out sc_lv 3 signal 1 } 
	{ csr1_rowptr_ce0 sc_out sc_logic 1 signal 1 } 
	{ csr1_rowptr_q0 sc_in sc_lv 32 signal 1 } 
	{ csr1_rowptr_address1 sc_out sc_lv 3 signal 1 } 
	{ csr1_rowptr_ce1 sc_out sc_logic 1 signal 1 } 
	{ csr1_rowptr_q1 sc_in sc_lv 32 signal 1 } 
	{ csr2_rowptr_address0 sc_out sc_lv 3 signal 2 } 
	{ csr2_rowptr_ce0 sc_out sc_logic 1 signal 2 } 
	{ csr2_rowptr_q0 sc_in sc_lv 32 signal 2 } 
	{ csr2_rowptr_address1 sc_out sc_lv 3 signal 2 } 
	{ csr2_rowptr_ce1 sc_out sc_logic 1 signal 2 } 
	{ csr2_rowptr_q1 sc_in sc_lv 32 signal 2 } 
	{ csr1_data_V_address0 sc_out sc_lv 5 signal 3 } 
	{ csr1_data_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ csr1_data_V_q0 sc_in sc_lv 32 signal 3 } 
	{ csr2_data_V_address0 sc_out sc_lv 5 signal 4 } 
	{ csr2_data_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ csr2_data_V_q0 sc_in sc_lv 32 signal 4 } 
	{ agg_result_data_V_address0 sc_out sc_lv 5 signal 5 } 
	{ agg_result_data_V_ce0 sc_out sc_logic 1 signal 5 } 
	{ agg_result_data_V_we0 sc_out sc_logic 1 signal 5 } 
	{ agg_result_data_V_d0 sc_out sc_lv 32 signal 5 } 
	{ agg_result_colind_address0 sc_out sc_lv 5 signal 6 } 
	{ agg_result_colind_ce0 sc_out sc_logic 1 signal 6 } 
	{ agg_result_colind_we0 sc_out sc_logic 1 signal 6 } 
	{ agg_result_colind_d0 sc_out sc_lv 32 signal 6 } 
	{ csr1_colind_address0 sc_out sc_lv 5 signal 7 } 
	{ csr1_colind_ce0 sc_out sc_logic 1 signal 7 } 
	{ csr1_colind_q0 sc_in sc_lv 32 signal 7 } 
	{ csr2_colind_address0 sc_out sc_lv 5 signal 8 } 
	{ csr2_colind_ce0 sc_out sc_logic 1 signal 8 } 
	{ csr2_colind_q0 sc_in sc_lv 3 signal 8 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	agg_result_rowptr { ap_memory {  { agg_result_rowptr_address0 mem_address 1 3 }  { agg_result_rowptr_ce0 mem_ce 1 1 }  { agg_result_rowptr_we0 mem_we 1 1 }  { agg_result_rowptr_d0 mem_din 1 32 }  { agg_result_rowptr_q0 mem_dout 0 32 } } }
	csr1_rowptr { ap_memory {  { csr1_rowptr_address0 mem_address 1 3 }  { csr1_rowptr_ce0 mem_ce 1 1 }  { csr1_rowptr_q0 mem_dout 0 32 }  { csr1_rowptr_address1 MemPortADDR2 1 3 }  { csr1_rowptr_ce1 MemPortCE2 1 1 }  { csr1_rowptr_q1 MemPortDOUT2 0 32 } } }
	...
	csr1_data_V { ap_memory {  { csr1_data_V_address0 mem_address 1 5 }  { csr1_data_V_ce0 mem_ce 1 1 }  { csr1_data_V_q0 mem_dout 0 32 } } }
	csr2_data_V { ap_memory {  { csr2_data_V_address0 mem_address 1 5 }  { csr2_data_V_ce0 mem_ce 1 1 }  { csr2_data_V_q0 mem_dout 0 32 } } }
	...
	agg_result_colind { ap_memory {  { agg_result_colind_address0 mem_address 1 5 }  { agg_result_colind_ce0 mem_ce 1 1 }  { agg_result_colind_we0 mem_we 1 1 }  { agg_result_colind_d0 mem_din 1 32 } } }
	csr1_colind { ap_memory {  { csr1_colind_address0 mem_address 1 5 }  { csr1_colind_ce0 mem_ce 1 1 }  { csr1_colind_q0 mem_dout 0 32 } } }

...
set C_modelArgList {
	...
	{ csr2_colind int 5 regular {array 20 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "agg_result_rowptr", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "csr2_colind", "interface" : "memory", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ csr2_colind_q0 sc_in sc_lv 5 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "csr2_colind_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "csr2_colind", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	csr2_colind { ap_memory {  { csr2_colind_address0 mem_address 1 5 }  { csr2_colind_ce0 mem_ce 1 1 }  { csr2_colind_q0 mem_dout 0 5 } } }

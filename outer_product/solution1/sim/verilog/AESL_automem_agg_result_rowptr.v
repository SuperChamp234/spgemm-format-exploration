...
module AESL_automem_agg_result_rowptr (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.outer_product.autotvin_agg_result_rowptr.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.outer_product.autotvout_agg_result_rowptr.dat"; 
//------------------------Local signal-------------------

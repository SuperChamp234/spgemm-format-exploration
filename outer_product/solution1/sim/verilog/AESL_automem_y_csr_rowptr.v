...
module AESL_automem_y_csr_rowptr (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.outer_product.autotvin_y_csr_rowptr.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.outer_product.autotvout_y_csr_rowptr.dat"; 
//------------------------Local signal-------------------

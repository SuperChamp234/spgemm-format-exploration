...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.outer_product.autotvin_agg_result_rowptr.dat"
         "c.outer_product.autotvin_agg_result_colind.dat"
         "c.outer_product.autotvin_agg_result_data_V.dat"
         "c.outer_product.autotvin_x_csc_colptr.dat"
         "c.outer_product.autotvin_x_csc_rowind.dat"
         "c.outer_product.autotvin_x_csc_data_V.dat"
         "c.outer_product.autotvin_y_csr_rowptr.dat"
         "c.outer_product.autotvin_y_csr_colind.dat"
         "c.outer_product.autotvin_y_csr_data_V.dat"
         "c.outer_product.autotvout_agg_result_rowptr.dat"
         "c.outer_product.autotvout_agg_result_colind.dat"
         "c.outer_product.autotvout_agg_result_data_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.outer_product.autotvout_agg_result_rowptr.dat"
         "rtl.outer_product.autotvout_agg_result_colind.dat"
         "rtl.outer_product.autotvout_agg_result_data_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

...
// 0  32 56   0	145
    ...
    csr_out_t test = {
        .rowptr= {0, 4, 7, 11, 14},
        .colind = new int[14]{0, 1, 2, 3, 0, 1, 3, 0, 1, 2, 4, 1, 2, 4},
        .data = new data_t[14]{1, 4, 5, 12, 12, 6, 18, 23, 28, 74, 56, 32, 56, 145}
    };
    csr_out_t test2 = {
        .rowptr= {0, 2, 4, 5, 8},
        .colind = new int[9]{0, 2, 1, 3, 0, 1, 2, 4},
        .data = new data_t[9]{1, 5, 2, 6, 3, 4, 7, 8}
    };

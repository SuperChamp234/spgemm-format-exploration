...
`define AUTOTB_TVIN_x_rowptr  "./c.outer_product.autotvin_x_rowptr.dat"
`define AUTOTB_TVIN_x_colind  "./c.outer_product.autotvin_x_colind.dat"
`define AUTOTB_TVIN_x_data  "./c.outer_product.autotvin_x_data.dat"
`define AUTOTB_TVIN_y_colptr  "./c.outer_product.autotvin_y_colptr.dat"
`define AUTOTB_TVIN_y_rowind  "./c.outer_product.autotvin_y_rowind.dat"
`define AUTOTB_TVIN_y_data  "./c.outer_product.autotvin_y_data.dat"
`define AUTOTB_TVIN_z_rowptr  "./c.outer_product.autotvin_z_rowptr.dat"
`define AUTOTB_TVIN_z_colind  "./c.outer_product.autotvin_z_colind.dat"
`define AUTOTB_TVIN_z_data  "./c.outer_product.autotvin_z_data.dat"
`define AUTOTB_TVIN_x_rowptr_out_wrapc  "./rtl.outer_product.autotvin_x_rowptr.dat"
`define AUTOTB_TVIN_x_colind_out_wrapc  "./rtl.outer_product.autotvin_x_colind.dat"
`define AUTOTB_TVIN_x_data_out_wrapc  "./rtl.outer_product.autotvin_x_data.dat"
`define AUTOTB_TVIN_y_colptr_out_wrapc  "./rtl.outer_product.autotvin_y_colptr.dat"
`define AUTOTB_TVIN_y_rowind_out_wrapc  "./rtl.outer_product.autotvin_y_rowind.dat"
`define AUTOTB_TVIN_y_data_out_wrapc  "./rtl.outer_product.autotvin_y_data.dat"
`define AUTOTB_TVIN_z_rowptr_out_wrapc  "./rtl.outer_product.autotvin_z_rowptr.dat"
`define AUTOTB_TVIN_z_colind_out_wrapc  "./rtl.outer_product.autotvin_z_colind.dat"
`define AUTOTB_TVIN_z_data_out_wrapc  "./rtl.outer_product.autotvin_z_data.dat"
`define AUTOTB_TVOUT_z_rowptr  "./c.outer_product.autotvout_z_rowptr.dat"
`define AUTOTB_TVOUT_z_colind  "./c.outer_product.autotvout_z_colind.dat"
`define AUTOTB_TVOUT_z_data  "./c.outer_product.autotvout_z_data.dat"
`define AUTOTB_TVOUT_z_rowptr_out_wrapc  "./impl_rtl.outer_product.autotvout_z_rowptr.dat"
`define AUTOTB_TVOUT_z_colind_out_wrapc  "./impl_rtl.outer_product.autotvout_z_colind.dat"
`define AUTOTB_TVOUT_z_data_out_wrapc  "./impl_rtl.outer_product.autotvout_z_data.dat"
module `AUTOTB_TOP;

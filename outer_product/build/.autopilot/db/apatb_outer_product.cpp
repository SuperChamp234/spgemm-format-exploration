...
#define AUTOTB_TVOUT_x_rowptr "../tv/cdatafile/c.outer_product.autotvout_x_rowptr.dat"
// wrapc file define:
#define AUTOTB_TVIN_x_colind "../tv/cdatafile/c.outer_product.autotvin_x_colind.dat"
#define AUTOTB_TVOUT_x_colind "../tv/cdatafile/c.outer_product.autotvout_x_colind.dat"
// wrapc file define:
#define AUTOTB_TVIN_x_data "../tv/cdatafile/c.outer_product.autotvin_x_data.dat"
#define AUTOTB_TVOUT_x_data "../tv/cdatafile/c.outer_product.autotvout_x_data.dat"
// wrapc file define:
#define AUTOTB_TVIN_y_colptr "../tv/cdatafile/c.outer_product.autotvin_y_colptr.dat"
#define AUTOTB_TVOUT_y_colptr "../tv/cdatafile/c.outer_product.autotvout_y_colptr.dat"
// wrapc file define:
#define AUTOTB_TVIN_y_rowind "../tv/cdatafile/c.outer_product.autotvin_y_rowind.dat"
#define AUTOTB_TVOUT_y_rowind "../tv/cdatafile/c.outer_product.autotvout_y_rowind.dat"
// wrapc file define:
#define AUTOTB_TVIN_y_data "../tv/cdatafile/c.outer_product.autotvin_y_data.dat"
#define AUTOTB_TVOUT_y_data "../tv/cdatafile/c.outer_product.autotvout_y_data.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_x_rowptr "../tv/rtldatafile/rtl.outer_product.autotvout_x_rowptr.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_x_colind "../tv/rtldatafile/rtl.outer_product.autotvout_x_colind.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_x_data "../tv/rtldatafile/rtl.outer_product.autotvout_x_data.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_y_colptr "../tv/rtldatafile/rtl.outer_product.autotvout_y_colptr.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_y_rowind "../tv/rtldatafile/rtl.outer_product.autotvout_y_rowind.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_y_data "../tv/rtldatafile/rtl.outer_product.autotvout_y_data.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_z_rowptr "../tv/rtldatafile/rtl.outer_product.autotvout_z_rowptr.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_z_colind "../tv/rtldatafile/rtl.outer_product.autotvout_z_colind.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_z_data "../tv/rtldatafile/rtl.outer_product.autotvout_z_data.dat"
...
string get_depth_list () {
  ...
  total_list << "{y_colptr " << y_colptr_depth << "}\n";
  total_list << "{y_rowind " << y_rowind_depth << "}\n";
...
extern "C" void outer_product_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
//y_colptr
aesl_fh.touch(AUTOTB_TVIN_y_colptr);
aesl_fh.touch(AUTOTB_TVOUT_y_colptr);
//y_rowind
aesl_fh.touch(AUTOTB_TVIN_y_rowind);
aesl_fh.touch(AUTOTB_TVOUT_y_rowind);
//y_data
...
unsigned __xlx_offset_byte_param_y_colptr = 0;
// print y_colptr Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_y_colptr, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_y_colptr = 0*4;
  if (__xlx_apatb_param_y_colptr) {
    for (int j = 0  - 0, e = 25 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_y_colptr)[j];
  ...
  tcl_file.set_num(25, &tcl_file.y_colptr_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_y_colptr, __xlx_sprintf_buffer.data());
}
unsigned __xlx_offset_byte_param_y_rowind = 0;
// print y_rowind Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_y_rowind, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_y_rowind = 0*4;
  if (__xlx_apatb_param_y_rowind) {
    for (int j = 0  - 0, e = 25 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_y_rowind)[j];
  ...
  tcl_file.set_num(25, &tcl_file.y_rowind_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_y_rowind, __xlx_sprintf_buffer.data());
}
...
outer_product_hw_stub_wrapper(__xlx_apatb_param_x_rowptr, __xlx_apatb_param_x_colind, __xlx_apatb_param_x_data, __xlx_apatb_param_y_colptr, __xlx_apatb_param_y_rowind, __xlx_apatb_param_y_data, __xlx_apatb_param_z_rowptr, __xlx_apatb_param_z_colind, __xlx_apatb_param_z_data);

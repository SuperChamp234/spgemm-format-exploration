...
//------------------------Parameter----------------------
`define TV_IN_z_colind "../tv/cdatafile/c.outer_product.autotvin_z_colind.dat"
`define TV_OUT_z_colind "../tv/rtldatafile/rtl.outer_product.autotvout_z_colind.dat"
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > z_colind_mem_depth) begin
                $display ("/home/leoh/spgemm-format-exploration/outer_product/build/sim/verilog/AESL_axi_master_z_colind.v: Write request address %d exceed AXI master z_colind array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, z_colind_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > z_colind_mem_depth) begin
                $display ("/home/leoh/spgemm-format-exploration/outer_product/build/sim/verilog/AESL_axi_master_z_colind.v: Read request address %d exceed AXI master z_colind array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, z_colind_mem_depth); 
                $finish;
            end

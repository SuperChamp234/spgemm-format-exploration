...
//------------------------Parameter----------------------
`define TV_IN_y_data "../tv/cdatafile/c.outer_product.autotvin_y_data.dat"
`define TV_OUT_y_data "../tv/rtldatafile/rtl.outer_product.autotvout_y_data.dat"
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > y_data_mem_depth) begin
                $display ("/home/leoh/spgemm-format-exploration/outer_product/build/sim/verilog/AESL_axi_master_y_data.v: Write request address %d exceed AXI master y_data array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, y_data_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > y_data_mem_depth) begin
                $display ("/home/leoh/spgemm-format-exploration/outer_product/build/sim/verilog/AESL_axi_master_y_data.v: Read request address %d exceed AXI master y_data array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, y_data_mem_depth); 
                $finish;
            end

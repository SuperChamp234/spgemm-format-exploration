...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.outer_product.autotvin_x_rowptr.dat"
         "c.outer_product.autotvin_x_colind.dat"
         "c.outer_product.autotvin_x_data.dat"
         "c.outer_product.autotvin_y_colptr.dat"
         "c.outer_product.autotvin_y_rowind.dat"
         "c.outer_product.autotvin_y_data.dat"
         "c.outer_product.autotvin_z_rowptr.dat"
         "c.outer_product.autotvin_z_colind.dat"
         "c.outer_product.autotvin_z_data.dat"
         "c.outer_product.autotvout_z_rowptr.dat"
         "c.outer_product.autotvout_z_colind.dat"
         "c.outer_product.autotvout_z_data.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.outer_product.autotvout_z_rowptr.dat"
         "rtl.outer_product.autotvout_z_colind.dat"
         "rtl.outer_product.autotvout_z_data.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

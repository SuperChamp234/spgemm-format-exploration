...
//------------------------Parameter----------------------
`define TV_IN_x_data "../tv/cdatafile/c.outer_product.autotvin_x_data.dat"
`define TV_OUT_x_data "../tv/rtldatafile/rtl.outer_product.autotvout_x_data.dat"
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > x_data_mem_depth) begin
                $display ("/home/leoh/spgemm-format-exploration/outer_product/build/sim/verilog/AESL_axi_master_x_data.v: Write request address %d exceed AXI master x_data array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, x_data_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > x_data_mem_depth) begin
                $display ("/home/leoh/spgemm-format-exploration/outer_product/build/sim/verilog/AESL_axi_master_x_data.v: Read request address %d exceed AXI master x_data array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, x_data_mem_depth); 
                $finish;
            end

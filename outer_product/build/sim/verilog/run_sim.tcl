...
if {[file isfile outer_product.autotvin.dat]} {
	file delete -force outer_product.autotvin.dat
}

if {[file isfile outer_product.autotvout.dat]} {
	file delete -force outer_product.autotvout.dat
}

...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/leoh/tools/Vitis_HLS/2020.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/leoh/tools/Vitis_HLS/2020.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/leoh/tools/Vitis_HLS/2020.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/leoh/tools/Vitis_HLS/2020.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ::env(LD_LIBRARY_PATH) /home/leoh/tools/Vitis_HLS/2020.2/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "outer_product.autotvin.dat"
	set constFileTvOut       "outer_product.autotvout.dat"
	set constFileHdlTvIn     "outer_product.autohdltvin.dat"
	set constFileHdlTvOut    "outer_product.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
